...
<body class="home">
	<!-- Fixed navbar -->
	<div class="navbar navbar-inverse navbar-fixed-top headroom" style="height:10%;" >
		<div class="container">
			...
			<div class="navbar-collapse collapse">
                				<img src="./image/rsz_1logo.png" alt="Progressus HTML5 template" class="img-fluid float-left" style="width: 10%;">
