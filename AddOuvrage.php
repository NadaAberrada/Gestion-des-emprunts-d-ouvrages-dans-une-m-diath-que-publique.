...
<body>
    ...
    <div id="border">
        <form method="POST" action="" enctype="multipart/form-data" style="margin-left:5%;margin-right:5%">
            <h3 class="mb-5 text-center">Add Work</h3>
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="form-outline">
                        <input name="title" type="text" id="title" class="form-control form-control-lg" placeholder="title" required />

                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="form-outline">
                        <input name="author" type="text" id="author" class="form-control form-control-lg" placeholder="author" required />

                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="form-outline">
                        <input type="file" name="image" id="img" class="form-control form-control-lg" required />
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="form-outline">
                        <!-- <input name="etat" type="text" id="etat" class="form-control form-control-lg" placeholder="etat" required /> -->
            ...
            <div class="form-outline mb-4">
                <input name="type" type="text" id="type" class="form-control form-control-lg" style="border: 1px solid #A5A1A1;" placeholder="type" required />

            </div>
            <div class="form-outline mb-4">
                <h6 class="">DateEdition</h6>
                <input name="DateEdition" type="date" id="DateEdition" class="form-control form-control-lg" style="border: 1px solid #A5A1A1;" required />
            ...
            <div class="form-outline mb-4">
                ...
                <input name="DateAchat" type="date" id="DateAchat" class="form-control form-control-lg" style="border: 1px solid #A5A1A1;" required />

            </div>
            <div class="form-outline mb-4">
                <input name="pages" type="text" id="pages" class="form-control form-control-lg" style="border: 1px solid #A5A1A1;" placeholder="pages" required />
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['etat']!="#") {
        $title = $_POST["title"];
        $author = $_POST["author"];
        $etat = $_POST['etat'];
        ...
        $stmt = $conn->prepare("INSERT INTO `ouvrage`(
        `ouvre_titre`, 
        `ouvre_auteur`, 
        `ouvre_img`, 
        `ouvre_etat`, 
        ...
        $stmt->bindParam(6, $DateEdition);
        $stmt->bindParam(7, $DateAchat);
        $stmt->bindParam(8, $pages);
        $stmt->bindParam(9, $idadmin);
