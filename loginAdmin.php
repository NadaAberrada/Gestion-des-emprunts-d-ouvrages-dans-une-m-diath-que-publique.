...
<body style="background-color: #55595c ;">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black">
                                    ...
                                    <h3 class="mb-5 text-center">Welcome back. You have successfully logged in to the website</h3>
    ...
    if (isset($_POST['email']) && isset($_POST['password'])) {
        ...
        try {
            ...
            $stmt1 = $conn->query("SELECT * FROM `bibliothecaire` WHERE  `bib_email`='$email '");
            $stmt2 = $conn->query("SELECT * FROM `bibliothecaire` WHERE  `bib_pass`='$password'");
            ...
            } elseif (!$passLigne && !password_verify($password, $emailLigne["bib_pass"])) {
                $error = " mot de passe incorrect.";
                echo "<div style='background-color: #55595c ;color:red'>" . $error . "</div>";
            } else {

                $_SESSION['user'] = $emailLigne['bib_nom'];
                $_SESSION['idAdmin'] = $emailLigne['bib_id'];
                echo "in";
